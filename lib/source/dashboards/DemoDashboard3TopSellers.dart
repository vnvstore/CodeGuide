...
class DemoDashboard3TopSellers extends StatefulWidget {
  static String tag = '/DemoDashboard3TopSellers';

  @override
  DemoDashboard3TopSellersState createState() => DemoDashboard3TopSellersState();
}

const fontMedium = 'Medium';
const fontBold = 'Bold';

class DemoDashboard3TopSellersState extends State<DemoDashboard3TopSellers> {
