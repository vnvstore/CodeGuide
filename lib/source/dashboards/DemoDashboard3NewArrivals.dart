...
import 'model/Db3Model.dart';
import 'utils/DbColors.dart';
import 'utils/DbDataGenerator.dart';
import 'utils/DbStrings.dart';
import 'utils/DbImages.dart';

class DemoDashboard3NewArrivals extends StatefulWidget {
  static String tag = '/DemoDashboard3NewArrivals';

  @override
  DemoDashboard3NewArrivalsState createState() => DemoDashboard3NewArrivalsState();
}

const fontMedium = 'Medium';
const fontBold = 'Bold';

class DemoDashboard3NewArrivalsState extends State<DemoDashboard3NewArrivals> {
