...
class DemoDashboard5 extends StatefulWidget {
  static String tag = '/DemoDashboard5';

  @override
  DemoDashboard5State createState() => DemoDashboard5State();
}

const fontMedium = 'Medium';
const fontBold = 'Bold';

class DemoDashboard5State extends State<DemoDashboard5> {
