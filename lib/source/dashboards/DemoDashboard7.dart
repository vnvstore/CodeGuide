...
class DemoDashboard7 extends StatefulWidget {
  static String tag = '/DemoDashboard7';

  @override
  DemoDashboard7State createState() => DemoDashboard7State();
}

class DemoDashboard7State extends State<DemoDashboard7> {
