...
class DemoDashboard1 extends StatefulWidget {
  static String tag = '/DemoDashboard1';

  @override
  DemoDashboard1State createState() => DemoDashboard1State();
}

const fontMedium = 'Medium';

class DemoDashboard1State extends State<DemoDashboard1> {
