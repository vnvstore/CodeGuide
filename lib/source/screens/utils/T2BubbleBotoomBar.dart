...
BubbleBottomBarItem tab(IconData iconData, String tabName) {
  return BubbleBottomBarItem(
      backgroundColor: t2_colorPrimary, icon: Icon(iconData, color: Color(0xFF212121)), activeIcon: Icon(iconData, color: t2_colorPrimary), title: Text(tabName, style: primaryTextStyle()));
}
