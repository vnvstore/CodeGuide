    ...
    data: ThemeData.light(),
        child: SimpleDialog(
          title: Column(
            ...
            children: <Widget>[
              text("Select Country Code", textColor: appStore.textPrimaryColor, fontSize: 16.0, fontFamily: 'Semibold'),
              SizedBox(height: 8),
              TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(), fontSize: 16.0, textColor: appStore.textPrimaryColor)),
                text(e.dialCode, fontSize: 16.0, textColor: appStore.textPrimaryColor, fontFamily: 'Semibold'),
              ],
            ),
          ),
        ],
