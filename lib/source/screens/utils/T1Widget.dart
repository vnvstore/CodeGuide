...
Text formHeading(var label) {
  return Text(label, style: TextStyle(color: textPrimaryColor, fontSize: 30, fontFamily: 'Bold'), textAlign: TextAlign.center);
}

Text formSubHeadingForm(var label) {
  return Text(label, style: TextStyle(color: textSecondaryColor, fontSize: 20, fontFamily: 'Bold'), textAlign: TextAlign.center);
}
...
Text listHeading(var label) {
  return Text(label, style: TextStyle(color: textPrimaryColor, fontSize: 20, fontFamily: 'Bold'), textAlign: TextAlign.left);
}

Text listDesignationHeading(var label) {
  return Text(label, style: TextStyle(color: textPrimaryColor, fontSize: 16, fontFamily: 'Medium'), textAlign: TextAlign.left);
}
...
Text headerText(var text) {
  return Text(
    text,
    maxLines: 2,
    style: TextStyle(fontFamily: fontBold, fontSize: 22, color: textPrimaryColor),
  );
}

Text subHeadingText(var text) {
  return Text(text, style: TextStyle(fontFamily: fontBold, fontSize: 17.5, color: textSecondaryColor));
}
...
Widget ring(String description) {
  return Column(
    ...
    children: <Widget>[
      ...
      SizedBox(height: 16),
      text(description, textColor: textPrimaryColor, fontSize: textSizeNormal, fontFamily: fontSemibold, isCentered: true, maxLine: 2)
    ],
  );
}
