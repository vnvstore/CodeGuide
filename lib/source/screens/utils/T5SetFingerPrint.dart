            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  text(t5_lbl_fingerprint, textColor: appStore.textPrimaryColor, fontFamily: 'Bold', fontSize: 22.0),
                  Padding(
                    padding: const EdgeInsets.only(left: 30, right: 30, bottom: 16),
                    child: text(t5_note_finger_set, textColor: t5TextColorSecondary, fontFamily: 'Medium', fontSize: 16.0, maxLine: 2, isCentered: true),
                  ),
                  SizedBox(height: 50),
