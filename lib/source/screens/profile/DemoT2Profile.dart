...
class DemoT2Profile extends StatefulWidget {
  static var tag = "/DemoT2Profile";

  @override
  DemoT2ProfileState createState() => DemoT2ProfileState();
}

class DemoT2ProfileState extends State<DemoT2Profile> {
                                    ...
                                    Row(
                                      children: <Widget>[
                                        ...
                                        ClipRRect(
                                          ...
                                          child: CachedNetworkImage(placeholder: (context, url) => placeholderWidget(), imageUrl: t2_profile, width: 80, height: 80),
                                        ),
                                        SizedBox(width: 24),
                                        Container(
                                          child: Column(
