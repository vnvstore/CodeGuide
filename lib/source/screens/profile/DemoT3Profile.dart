...
class DemoT3Profile extends StatefulWidget {
  static var tag = "/DemoT3Profile";

  @override
  DemoT3ProfileState createState() => DemoT3ProfileState();
}

class DemoT3ProfileState extends State<DemoT3Profile> {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    return Container(
      child: Container(
        ...
        decoration: boxDecoration(radius: 10, bgColor:  t3_gray, showShadow: true),
        child: _tabBar,
      ),
    );
  }
