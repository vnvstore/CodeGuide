...
class DemoChoosePlanScreen1 extends StatefulWidget {
  @override
  DemoChoosePlanScreen1State createState() => DemoChoosePlanScreen1State();
}

class DemoChoosePlanScreen1State extends State<DemoChoosePlanScreen1> {
