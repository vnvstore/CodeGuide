...
class DemoChoosePlanScreen2 extends StatefulWidget {
  @override
  DemoChoosePlanScreen2State createState() => DemoChoosePlanScreen2State();
}

class DemoChoosePlanScreen2State extends State<DemoChoosePlanScreen2> {
