...
class DemoChoosePlanScreen7 extends StatefulWidget {
  @override
  DemoChoosePlanScreen7State createState() => DemoChoosePlanScreen7State();
}

class DemoChoosePlanScreen7State extends State<DemoChoosePlanScreen7> {
                  ...
                  Align(
                    ...
                    child: AppButton(
                      ...
                      onTap: () {
                        ...
                        snackBar(context, title: "${planPeriodList[index].title}", backgroundColor: appStore.appColorPrimary);
                      },
