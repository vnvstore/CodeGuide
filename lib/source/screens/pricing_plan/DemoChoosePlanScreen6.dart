...
class DemoChoosePlanScreen6 extends StatefulWidget {
  @override
  DemoChoosePlanScreen6State createState() => DemoChoosePlanScreen6State();
}

class DemoChoosePlanScreen6State extends State<DemoChoosePlanScreen6> {
