...
class DemoT4SignIn extends StatefulWidget {
  static String tag = '/DemoT4SignIn';

  @override
  DemoT4SignInState createState() => DemoT4SignInState();
}

class DemoT4SignInState extends State<DemoT4SignIn> {
  @override
                ...
                child: Column(
                  children: <Widget>[
                    CachedNetworkImage(
                        ...
                        imageUrl: t4_icon, width: width / 3.2),
                    SizedBox(height: 40),
                    ...
                    SizedBox(height: 48),
                    text(t4_lbl_login_with, textColor: t4_white, fontFamily: 'Medium', fontSize: 18.0),
                    SizedBox(height: 24),
                    Row(
