...
class DemoT6Setting extends StatefulWidget {
  static String tag = '/DemoT6Setting';

  @override
  DemoT6SettingState createState() => DemoT6SettingState();
}

class DemoT6SettingState extends State<DemoT6Setting> {
