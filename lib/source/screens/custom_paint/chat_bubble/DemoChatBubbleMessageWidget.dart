...
import 'DemoChatBubbleCustomPainter.dart';
import 'modal/DemoChatBubbleModal.dart';

class DemoChatBubbleMessageWidget extends StatelessWidget {
  bool? isMe;
  DemoChatBubbleModal? data;

  DemoChatBubbleMessageWidget({this.isMe, this.data});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: CustomPaint(
              painter: DemoChatBubbleCustomPainter(color: Colors.blue, alignment: isMe.validate() ? Alignment.topLeft : Alignment.topRight),
              child: Container(
