...
import 'DemoCardCustomPainter.dart';

class DemoCardScreen extends StatefulWidget {
  @override
  DemoCardScreenState createState() => DemoCardScreenState();
}

class DemoCardScreenState extends State<DemoCardScreen> {
  @override
  void initState() {
    super.initState();
    init();
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                child: CustomPaint(
                  painter: DemoCustomContainerShapeBorder(height: 100.0, width: 300.0, radius: 50.0, fillColor: context.cardColor),
                ),
              ),
            ),
            Positioned(
