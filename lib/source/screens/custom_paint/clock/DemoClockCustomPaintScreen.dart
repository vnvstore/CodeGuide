...
import 'DemoClockCustomPainter.dart';

class DemoClockCustomPaintScreen extends StatefulWidget {
  @override
  _DemoClockCustomPaintScreenState createState() => _DemoClockCustomPaintScreenState();
}

class _DemoClockCustomPaintScreenState extends State<DemoClockCustomPaintScreen> {
  Timer? _timer;
  ...
  Widget dialSettings() {
    return SettingSection(
      headingDecoration: boxDecorationDefault(color: Color(0xFFECECEC), borderRadius: radius(0)),
  ...
  Widget clock() {
    return Transform.rotate(
      angle: -(DemoClockCustomPainter.oneDegreeInRadian * 90),
      child: CustomPaint(
        willChange: true,
        size: Size.square(180),
        painter: DemoClockCustomPainter(
