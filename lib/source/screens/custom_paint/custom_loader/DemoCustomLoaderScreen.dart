...
import 'DemoCustomLoaderPainter.dart';

class DemoCustomLoaderScreen extends StatefulWidget {
  @override
  DemoCustomLoaderScreenState createState() => DemoCustomLoaderScreenState();
}

class DemoCustomLoaderScreenState extends State<DemoCustomLoaderScreen> with SingleTickerProviderStateMixin {
  ...
  static Widget buildButtonAnimation({required double height, required double width, required double percentValue, required Function onPress}) {
    return Center(
      child: Container(
        ...
        width: width,
        child: CustomPaint(
          foregroundPainter: DemoCustomLoaderPainter(buttonBorderColor: Colors.grey[300], progressColor: Colors.blue, percentage: percentValue, width: 8.0),
          child: AppButton(
            color: Colors.red,
