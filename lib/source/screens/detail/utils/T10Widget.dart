      ...
      return TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: UnderlineInputBorder(
            borderSide: BorderSide(color: Color(0xFF212121), width: 0.0),
          ),
        ...
        style: TextStyle(fontSize: widget.fontSize, color: Color(0xFF212121), fontFamily: widget.fontFamily),
      );
    } else {
      return TextField(
        controller: widget.mController,
        ...
        decoration: InputDecoration(
          suffixIcon: GestureDetector(
            ...
            child: Icon(widget.isPassword ? Icons.visibility : Icons.visibility_off, color: Color(0xFF212121)),
          ),
          contentPadding: EdgeInsets.fromLTRB(16, 8, 4, 8),
          hintText: widget.text,
          labelText: widget.text,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            SvgPicture.asset(t10_ic_search, color: Color(0xFF212121)).paddingOnly(right: 16),
          ],
        ),
      ),
    );
