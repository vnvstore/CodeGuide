  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(color: widget.bgColor, borderRadius:BorderRadius.circular(6))),
    );
  }
}

Widget backIcon(BuildContext context, var color, var icon, var iconColor) {
  return Container(width: 38, height: 38, decoration: BoxDecoration(color: color, borderRadius:BorderRadius.circular(10)), child: Icon(icon, color: iconColor)).onTap(() {
    finish(context);
  });
}
...
Container T7EditTextStyle(var hintText, var text, {isPassword = false}) {
  return Container(
    child: TextFormField(
      style: TextStyle(color: Color(0xFF000000), fontSize: textSizeMedium, fontFamily: fontRegular),
