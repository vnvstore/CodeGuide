...
class DemoT9Description extends StatefulWidget {
  static String tag = '/DemoT9Description';

  @override
  DemoT9DescriptionState createState() => DemoT9DescriptionState();
}

class DemoT9DescriptionState extends State<DemoT9Description> {
...
Widget T9OptionDescription(var total, var type) {
  return Container(
    ...
    child: Column(
      children: <Widget>[
        CachedNetworkImage(
            placeholder: (context, url) => Image.asset('images/LikeButton/image/grey.jpg', fit: BoxFit.cover),
            imageUrl: t9_ic_cup, height: 20, width: 20),
        SizedBox(height: 4),
