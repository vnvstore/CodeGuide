...
class DemoT2Listing extends StatefulWidget {
  static var tag = "/DemoT2Listing";

  @override
  DemoT2ListingState createState() => DemoT2ListingState();
}

class DemoT2ListingState extends State<DemoT2Listing> {
  int selectedPos = 1;
                            ...
                            child: Row(
                              children: <Widget>[
                                CachedNetworkImage(
                                    ...
                                    imageUrl: mListings[index].icon, width: width / 3, height: width / 2.8, fit: BoxFit.fill),
                                Container(
