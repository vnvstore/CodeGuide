...
class DemoT8Cards extends StatefulWidget {
  static String tag = '/DemoT8Cards';

  @override
  DemoT8CardsState createState() => DemoT8CardsState();
}

class DemoT8CardsState extends State<DemoT8Cards> {
  ...
  Widget DemoT8Cardselection(var option, var option1, callBack) {
    return InkWell(
      onTap: () {
        callBack();
      },
      child: Container(
        ...
        decoration: boxDecoration(showShadow: false, bgColor: Color(0xFFEFEFEF), radius: 10, color: t8_view_color),
          ...
          child: Draggable(
            ...
            feedback: Material(
              child: GestureDetector(
                child: Container(
                  decoration: boxDecoration(radius: 20, bgColor: Color(0xFFEFEFEF), showShadow: true),
                  child: Column(
                    children: <Widget>[
                      Container(
                        height: 200.0,
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            DemoT8Cardselection("A.", planetCard[x].option1, () {
                              removeCards(x);
                            }),
                            DemoT8Cardselection("B.", planetCard[x].option2, () {
                              removeCards(x);
                            }),
                            DemoT8Cardselection("C.", planetCard[x].option3, () {
                              removeCards(x);
                            }),
                            DemoT8Cardselection("D.", planetCard[x].option4, () {
                              removeCards(x);
                            }),
                          ],
                        ),
