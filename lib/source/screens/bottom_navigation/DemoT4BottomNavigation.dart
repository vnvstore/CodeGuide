...
class DemoT4BottomNavigation extends StatefulWidget {
  static var tag = "/DemoT4BottomNavigation";

  @override
  DemoT4BottomNavigationState createState() => DemoT4BottomNavigationState();
}

class DemoT4BottomNavigationState extends State<DemoT4BottomNavigation> {
