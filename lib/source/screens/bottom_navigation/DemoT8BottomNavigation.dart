...
class DemoT8BottomNavigation extends StatefulWidget {
  static String tag = '/DemoT8BottomNavigation';

  @override
  DemoT8BottomNavigationState createState() => DemoT8BottomNavigationState();
}

class DemoT8BottomNavigationState extends State<DemoT8BottomNavigation> {
  var isSelected = 1;
