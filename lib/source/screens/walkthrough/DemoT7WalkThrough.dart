...
class DemoT7WalkThrough extends StatefulWidget {
  static String tag = '/DemoT7WalkThrough';

  @override
  DemoT7WalkThroughState createState() => DemoT7WalkThroughState();
}

class DemoT7WalkThroughState extends State<DemoT7WalkThrough> {
