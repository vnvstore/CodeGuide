...
class DemoT6WalkThrough extends StatefulWidget {
  static String tag = '/DemoT6WalkThrough';

  @override
  DemoT6WalkThroughState createState() => DemoT6WalkThroughState();
}

class DemoT6WalkThroughState extends State<DemoT6WalkThrough> {
