...
import '../signup/DemoT1Signup.dart';
import '../utils/AppWidget.dart';
import '../utils/T1Images.dart';
import 't1_walk/IntroScreen.dart';
import 't1_walk/Walkthrough.dart';

class DemoT1WalkThrough extends StatelessWidget {
  static var tag = "/DemoT1WalkThrough";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        child: IntroScreen(
          list,
          MaterialPageRoute(builder: (context) => DemoT1Signup()),
        ),
      ),
    );
  }
