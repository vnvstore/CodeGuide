...
class DemoNoSentMailScreen extends StatefulWidget {
  const DemoNoSentMailScreen({Key? key}) : super(key: key);

  @override
  _DemoNoSentMailScreenState createState() => _DemoNoSentMailScreenState();
}

class _DemoNoSentMailScreenState extends State<DemoNoSentMailScreen> {
  @override
  void initState() {
