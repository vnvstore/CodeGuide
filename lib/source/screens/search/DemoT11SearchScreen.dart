...
class DemoT11SearchScreen extends StatefulWidget {
  static String tag = '/DemoT11SearchScreen';

  @override
  DemoT11SearchScreenState createState() => DemoT11SearchScreenState();
}

class DemoT11SearchScreenState extends State<DemoT11SearchScreen> {
          ...
          children: [
            SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  64.height,
                  Text(t11_lbl_search_result, style: boldTextStyle(color: appStore.appColorPrimary, size: 18)),
                  32.height,
                  Stack(
                    children: [
