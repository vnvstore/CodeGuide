...
class DemoT3Search extends StatefulWidget {
  static var tag = "/DemoT3Search";

  @override
  DemoT3SearchState createState() => DemoT3SearchState();
}

class DemoT3SearchState extends State<DemoT3Search> {
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return DemoT3SearchList(mListings[index], index);
                  },
                ),
              ),
            ],
...
class DemoT3SearchList extends StatelessWidget {
  late Theme3Dish model;

  DemoT3SearchList(Theme3Dish model, int pos) {
    this.model = model;
  }
