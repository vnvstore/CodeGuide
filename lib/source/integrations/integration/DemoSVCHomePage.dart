...
import 'package:showcaseview/showcaseview.dart';  //https://pub.dev/packages/showcaseview

import 'model/ExamCardModel.dart';
import 'model/LessonsModel.dart';
import 'model/LiveVideo.dart';

class DemoSVCHomePage extends StatefulWidget {
  static String tag = '/DemoSVCHomePage';

  @override
  _DemoSVCHomePageState createState() => _DemoSVCHomePageState();
}
...
class _DemoSVCHomePageState extends State<DemoSVCHomePage> {
                                        ...
                                        children: <Widget>[
                                          ...
                                          FittedBox(
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(color: sdSecondaryColorRed, borderRadius: BorderRadius.circular(4) ),
