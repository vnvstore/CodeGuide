...
class DemoFingerprintAuthentication extends StatefulWidget {
  static String tag = '/DemoFingerprintAuthentication';

  @override
  _DemoFingerprintAuthenticationState createState() => _DemoFingerprintAuthenticationState();
}

class _DemoFingerprintAuthenticationState extends State<DemoFingerprintAuthentication> {
