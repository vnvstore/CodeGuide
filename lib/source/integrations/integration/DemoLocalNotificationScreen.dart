...
import 'package:flutter_local_notifications/flutter_local_notifications.dart';  //https://pub.dev/packages/flutter_local_notifications
import 'package:nb_utils/nb_utils.dart';  //https://pub.dev/packages/nb_utils

class DemoLocalNotificationScreen extends StatefulWidget {
  static String tag = '/DemoLocalNotificationScreen';

  @override
  DemoLocalNotificationScreenState createState() => DemoLocalNotificationScreenState();
}

class DemoLocalNotificationScreenState extends State<DemoLocalNotificationScreen> {
