...
class DemoStackedChart6Screen extends StatefulWidget {
  @override
  DemoStackedChart6ScreenState createState() => DemoStackedChart6ScreenState();
}

class DemoStackedChart6ScreenState extends State<DemoStackedChart6Screen> {
  List<SalesData> data = [
    SalesData('Jan', 35),
    SalesData('Feb', 28),
    SalesData('Mar', 34),
