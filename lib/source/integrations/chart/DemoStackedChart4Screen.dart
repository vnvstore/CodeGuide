...
class DemoStackedChart4Screen extends StatefulWidget {
  @override
  DemoStackedChart4ScreenState createState() => DemoStackedChart4ScreenState();
}

class DemoStackedChart4ScreenState extends State<DemoStackedChart4Screen> {
