...
class DemoMWDataTableScreen extends StatefulWidget {
  static String tag = '/DemoMWDataTableScreen';

  @override
  DemoMWDataTableScreenState createState() => DemoMWDataTableScreenState();
}

class DemoMWDataTableScreenState extends State<DemoMWDataTableScreen> {
  late bool sort;
