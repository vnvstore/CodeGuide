...
class DemoAMAnimatedBuilderScreen extends StatefulWidget {
  static String tag = '/DemoAMAnimatedBuilderScreen';

  @override
  DemoAMAnimatedBuilderScreenState createState() => DemoAMAnimatedBuilderScreenState();
}

class DemoAMAnimatedBuilderScreenState extends State<DemoAMAnimatedBuilderScreen> with TickerProviderStateMixin {
