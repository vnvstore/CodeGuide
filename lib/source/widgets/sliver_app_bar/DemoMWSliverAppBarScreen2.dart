...
class DemoMWSliverAppBarScreen2 extends StatefulWidget {
  static String tag = '/DemoMWSliverAppBarScreen2';

  @override
  _DemoMWSliverAppBarScreen2State createState() => _DemoMWSliverAppBarScreen2State();
}

class _DemoMWSliverAppBarScreen2State extends State<DemoMWSliverAppBarScreen2> {
  var text;

  @override
  void initState() {
    super.initState();
    text = createText(numParagraphs: 8, numSentences: 5);
  }
      ...
      body: NestedScrollView(
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Text(text, textAlign: TextAlign.justify, style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        ),
  ...
  String createParagraph({int numSentences = -1, int numParagraphs = 1}) {
    ...
    if (numParagraphs > 1) return createText(numSentences: numSentences, numParagraphs: numParagraphs);
