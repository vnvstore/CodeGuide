...
class DemoIMDraggableScreen2 extends StatefulWidget {
  static String tag = '/DemoIMDraggableScreen2';

  @override
  _DemoIMDraggableScreen2State createState() => _DemoIMDraggableScreen2State();
}

class _DemoIMDraggableScreen2State extends State<DemoIMDraggableScreen2> with TickerProviderStateMixin {
