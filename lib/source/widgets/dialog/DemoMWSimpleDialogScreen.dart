...
class DemoMWSimpleDialogScreen extends StatefulWidget {
  ...
  @override
  DemoMWSimpleDialogScreenState createState() => DemoMWSimpleDialogScreenState();
}
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(text: "Cancel", style: TextStyle(fontSize: 16.0, color: Colors.blueAccent, fontFamily: 'Regular')),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(text: "Delete", style: TextStyle(fontSize: 16.0, color: Colors.white, fontFamily: 'Regular')),
                            ],
                          ),
                        ),
                      ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(
              child: Container(
                decoration: BoxDecoration(borderRadius:BorderRadius.circular(20), color: Theme.of(context).dividerColor),
            ...
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(text: "Photo Settings", style: TextStyle(fontSize: 16.0, color: appStore.textPrimaryColor, fontFamily: 'Regular')),
                ],
              ),
            ),
            20.height,
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(text: "Help and feedback", style: TextStyle(fontSize: 16.0, color: appStore.textPrimaryColor, fontFamily: 'Regular')),
                ],
              ),
            ),
            20.height,
