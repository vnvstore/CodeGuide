...
class DemoMWBottomNavigationScreen3 extends StatefulWidget {
  static String tag = '/DemoMWBottomNavigationScreen3';

  @override
  MWBottomNavigationScreenState createState() => MWBottomNavigationScreenState();
}

class MWBottomNavigationScreenState extends State<DemoMWBottomNavigationScreen3> {
  int currentIndex3 = 0;
